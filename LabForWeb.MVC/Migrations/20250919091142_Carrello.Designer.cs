...
namespace LabForWeb.MVC.Migrations
{
    ...
    [Migration("20250919091142_Carrello")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LabForWeb.MVC.Data.Models.Carrello_Dettaglio", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LabForWeb.MVC.Data.Models.Carrello_Dettaglio", b =>
                {
                    ...
                    b.HasOne("LabForWeb.MVC.Data.Models.Prodotto", "Prodottto")
                        .WithMany("CarrelloDettaglio")
                        .HasForeignKey("ProdotttoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Carrello");

                    b.Navigation("Prodottto");
                });
            ...
            modelBuilder.Entity("LabForWeb.MVC.Data.Models.Prodotto", b =>
                {
                    b.Navigation("CarrelloDettaglio");
